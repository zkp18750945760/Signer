...
public class SelectSchoolYearDialog extends Dialog implements View.OnClickListener, PickerScrollView.onSelectListener {
    ...
    public SelectSchoolYearDialog(Context context, String theme) {
        super(context);
        this.mContext = context;
        this.theme = theme;
    }

    public SelectSchoolYearDialog(Context context, String theme, int themeResId, OnCloseListener listener) {
    ...
    private void initData() {
        ...
        datas.add(new Pickers("2014-2015", 0 + ""));
        datas.add(new Pickers("2015-2016", 1 + ""));
        datas.add(new Pickers("2016-2017", 2 + ""));
        datas.add(new Pickers("2017-2018", 3 + ""));
        datas.add(new Pickers("2018-2019", 4 + ""));
        datas.add(new Pickers("2019-2020", 5 + ""));
        datas.add(new Pickers("2020-2021", 6 + ""));
        datas.add(new Pickers("2021-2022", 7 + ""));
