        ...
        if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            switch (wifiState) {
                ...
                case WifiManager.WIFI_STATE_ENABLED:
                    SignApplication.getInstance().setEnableWifi(true);
                    break;
            ...
            if (activeNetwork != null) { // connected to the internet
                if (activeNetwork.isConnected()) {
                    if (activeNetwork.getType() == ConnectivityManager.TYPE_WIFI) {
                        ...
                        SignApplication.getInstance().setMobile(true);
                ...
                Log.e(TAG, "当前没有网络连接，请确保你已经打开网络 ");
                SignApplication.getInstance().setWifi(false);
                SignApplication.getInstance().setMobile(false);
                SignApplication.getInstance().setConnected(false);
