...
public class SubjectUIModel {
    ...
    public SubjectUIModel(Context context, OnSubjectItemClickListener onSubjectItemClickListener, OnSubjectItemLongClickListener onSubjectItemLongClickListener) {
        this.itemHeight = context.getResources().getDimensionPixelSize(R.dimen.weekItemHeightTotal);
     ...
     * @param curWeek
     */
    public void addSubjectLayout(LinearLayout layout, final List<SubjectBean> data, int curWeek) {
