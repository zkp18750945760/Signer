package com.zhoukp.signer.module.home.banner;
...
public class BannerPagerAdapter extends PagerAdapter {
    ...
    private ArrayList<PaletteImageView> mItems;
    private Context mContext;
    private LayoutInflater mInflater;

    public BannerPagerAdapter(ArrayList<PaletteImageView> items, Context context) {
        mContext = context;
